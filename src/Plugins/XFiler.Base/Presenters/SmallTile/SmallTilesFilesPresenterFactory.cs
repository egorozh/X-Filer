...
{
    public class SmallTilesFilesPresenterFactory : BaseFilesPresenterFactory
    {
        private IIndex<string, IFilesPresenter> _presenterFactory;

        public SmallTilesFilesPresenterFactory(IIndex<string, IFilesPresenter> presenterFactory)
            : base(Strings.Presenters_SmallTiles, CreateTemplate(), CreateIcon(), "ab0db79f-14a4-4818-adbf-f3441ec28f9c")
        {
        ...
        {
            var presenter = _presenterFactory["smallTile"];
        ...
        private static DataTemplate CreateTemplate()
        {
            const string? xaml = @"<DataTemplate xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
                        ...
                        <base:TileFilePresenter TileSize=""70.0""/>
                    </DataTemplate>";
