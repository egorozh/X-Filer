...
Namespace Microsoft.VisualBasic.CompilerServices
    ...
    Friend NotInheritable Class ExceptionUtils
        ...
        Friend Shared Function VbMakeIllegalForException() As System.Exception
            Return VbMakeExceptionEx(vbErrors.IllegalFor, SRExt.Format(SR.ID92)) ' 92 - IllegaFor
        End Function

        Friend Shared Function VbMakeObjNotSetException() As System.Exception
            Return VbMakeExceptionEx(vbErrors.ObjNotSet, SRExt.Format(SR.ID91)) ' 91 - ObjNotSet
        End Function
        ...
        Friend Shared Function GetWin32Exception(
            ...
            Return New ComponentModel.Win32Exception(System.Runtime.InteropServices.Marshal.GetLastWin32Error(), SRExt.Format(ResourceID, PlaceHolders))
        End Function
