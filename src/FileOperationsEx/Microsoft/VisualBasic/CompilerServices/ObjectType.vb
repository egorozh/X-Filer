...
DecimalExit:
        ...
        Friend Overloads Shared Function CTypeHelper(ByVal obj As Object, ByVal toType As TypeCode) As Object
            ...
            Throw New InvalidCastException(SRExt.Format(SR.InvalidCast_FromTo, VBFriendlyName(obj), VBFriendlyName(TypeFromTypeCode(toType))))
        ...
        Friend Overloads Shared Function CTypeHelper(ByVal obj As Object, ByVal toType As Type) As Object
            ...
            If toTypeCode = TypeCode.Object Then
                ...
                Else
                    ...
                    Else
                        Throw New InvalidCastException(SRExt.Format(SR.InvalidCast_FromTo, VBFriendlyName(fromType), VBFriendlyName(toType)))
                    End If
                End If
            Else
...
CheckForEnumAndExit:
        ...
        Private Shared Function GetNoValidOperatorException(ByVal Operand As Object) As Exception
            Return New InvalidCastException(SRExt.Format(SR.NoValidOperator_OneOperand, VBFriendlyName(Operand)))
        End Function
        ...
        Private Shared Function GetNoValidOperatorException(ByVal Left As Object, ByVal Right As Object) As Exception
            ...
            Else
                ...
                If LeftString IsNot Nothing Then
                    Substitution1 =
                        SRExt.Format(SR.NoValidOperator_StringType1, Strings.Left(LeftString, MAX_INSERTION_SIZE))
                Else
                    Substitution1 = SRExt.Format(SR.NoValidOperator_NonStringType1, VBFriendlyName(Left))
                End If
            End If
            ...
            Else
                ...
                If RightString IsNot Nothing Then
                    Substitution2 =
                        SRExt.Format(SR.NoValidOperator_StringType1, Strings.Left(RightString, MAX_INSERTION_SIZE))
                Else
                    Substitution2 = SRExt.Format(SR.NoValidOperator_NonStringType1, VBFriendlyName(Right))
                End If
            End If

            Return New InvalidCastException(SRExt.Format(SR.NoValidOperator_TwoOperands, Substitution1, Substitution2))
        End Function
