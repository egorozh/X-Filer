            ...
            Catch ex As Exception When IsMissingMemberException(ex)
                ...
                If objType.IsCOMObject() OrElse ((Not args Is Nothing) AndAlso (args.Length > 0)) Then
                    ...
                    If oTmp Is Nothing Then
                        Throw New MissingMemberException(SRExt.Format(SR.MissingMember_MemberNotFoundOnType2, name, VBFriendlyName(objType, o)))
                    Else
                        Try
        ...
        Public Shared Sub LateSetComplex(ByVal o As Object, ByVal objType As Type, ByVal name As String,
            ...
            Try
                ...
                If RValueBase AndAlso objType.IsValueType Then
                    ...
                    Throw New Exception(SRExt.Format(SR.RValueBaseForValueType, VBFriendlyName(objType, o), VBFriendlyName(objType, o)))
                End If
            ...
            Else
                ...
                If (Not mi Is Nothing) AndAlso (mi.MemberType = MemberTypes.Field) Then
                    ...
                    If fi.IsInitOnly Then
                        Throw New MissingMemberException(SRExt.Format(SR.MissingMember_ReadOnlyField2, name, VBFriendlyName(objType, o)))
                    End If
            ...
            Catch ex As TargetInvocationException
                ...
                ElseIf TypeOf ex.InnerException Is TargetParameterCountException Then
                    If (flags And BindingFlags.PutRefDispProperty) <> 0 Then
                        ...
                        Throw New MissingMemberException(SRExt.Format(SR.MissingMember_MemberSetNotFoundOnType2, name, VBFriendlyName(objType, o)))
                    Else
                        'Let was being called
                        Throw New MissingMemberException(SRExt.Format(SR.MissingMember_MemberLetNotFoundOnType2, name, VBFriendlyName(objType, o)))
                    End If
                Else
                    Throw ex.InnerException
                End If
            ...
            Else
                ...
                If Not objType.IsCOMObject() Then
                    ...
                    If members Is Nothing Or iNext = 0 Then
                        Throw New MissingMemberException(SRExt.Format(SR.MissingMember_NoDefaultMemberFound1, VBFriendlyName(objType, o)))
                    End If
        ...
        Public Shared Sub LateIndexSetComplex(ByVal o As Object, ByVal args() As Object, ByVal paramnames() As String,
            ...
            Try
                ...
                If RValueBase AndAlso o.GetType().IsValueType Then
                    Throw New Exception(SRExt.Format(SR.RValueBaseForValueType, o.GetType().Name, o.GetType().Name))
                End If
            Catch ex As System.MissingMemberException When OptimisticSet = True
                'A missing member exception means it has no Set member.  Silently handle the exception.
            End Try
        ...
        Friend Shared Function InternalLateCall(ByVal o As Object, ByVal objType As Type, ByVal name As String,
            ...
            If Not objType.IsCOMObject Then
                ...
                If MemberIsField(mi) Then
                    ...
                    Throw New ArgumentException(SRExt.Format(SR.ExpressionNotProcedure, name, VBFriendlyName(objType, o)))
                End If
            ...
            If Value Is Nothing Then
                ...
                If Not IsStatic Then
                    ...
                    Throw New NullReferenceException(
                        SRExt.Format(SR.NullReference_InstanceReqToAccessMember1, MemberToString(Member)))
                End If
            End If
        End Sub
