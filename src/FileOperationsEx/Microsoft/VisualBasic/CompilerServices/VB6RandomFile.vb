...
Namespace Microsoft.VisualBasic.CompilerServices
    ...
    Friend Class VB6RandomFile
        ...
        Friend Overloads Overrides Sub Lock(ByVal lStart As Long, ByVal lEnd As Long)
            If lStart > lEnd Then
                Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "Start"))
            End If
        ...
        Friend Overrides Sub GetObject(ByRef Value As Object, Optional ByVal RecordNumber As Long = 0,
            ...
            Else
                ...
                ElseIf vtype = VT.DBNull Then
                    Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_UnsupportedIOType1, "DBNull")), vbErrors.IllegalFuncCall)
                ElseIf vtype = VT.Empty Then
                    Value = Nothing
                ElseIf vtype = VT.Currency Then
                    Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_UnsupportedIOType1, "Currency")), vbErrors.IllegalFuncCall)
                Else
                    Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_UnsupportedIOType1, typ.FullName)), vbErrors.IllegalFuncCall)
                End If
            End If
        End Sub
        ...
        Friend Overrides Sub PutObject(ByVal Value As Object, Optional ByVal RecordNumber As Long = 0,
            ...
            If typ Is Nothing Then
                Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_UnsupportedIOType1, "Empty")), vbErrors.IllegalFuncCall)
            ...
            If typ Is GetType(System.Reflection.Missing) Then
                Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_UnsupportedIOType1, "Missing")), vbErrors.IllegalFuncCall)
            ...
            ElseIf ContainedInVariant AndAlso typ.IsValueType Then
                Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_PutObjectOfValueType1, VBFriendlyName(typ, Value))), vbErrors.IllegalFuncCall)

            Else
                Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_UnsupportedIOType1, VBFriendlyName(typ, Value))), vbErrors.IllegalFuncCall)
            End If
        End Sub
