...
Namespace Microsoft.VisualBasic.CompilerServices
    ...
    Public NotInheritable Class Operators
        ...
        Private Shared Function GetNoValidOperatorException(ByVal op As UserDefinedOperator, ByVal operand As Object) As Exception
            Return New InvalidCastException(SRExt.Format(SR.UnaryOperand2, OperatorNames(op), VBFriendlyName(operand)))
        End Function
        ...
        Private Shared Function GetNoValidOperatorException(ByVal op As UserDefinedOperator, ByVal left As Object, ByVal right As Object) As Exception
            ...
            Else
                ...
                If leftString IsNot Nothing Then
                    substitution1 =
                        SRExt.Format(SR.NoValidOperator_StringType1, Strings.Left(leftString, maxInsertionSize))
                Else
            ...
            Else
                ...
                If rightString IsNot Nothing Then
                    substitution2 =
                        SRExt.Format(SR.NoValidOperator_StringType1, Strings.Left(rightString, maxInsertionSize))
                Else
                    substitution2 = SRExt.Format(SR.NoValidOperator_NonStringType1, VBFriendlyName(right))
                End If
            End If

            Return New InvalidCastException(SRExt.Format(SR.BinaryOperands3, OperatorNames(op), substitution1, substitution2))
        End Function
