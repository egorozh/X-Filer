    ...
    Friend NotInheritable Class PutHandler
        ...
        Function Callback(ByVal field_info As Reflection.FieldInfo, ByRef vValue As Object) As Boolean Implements IRecordEnum.Callback
            ...
            If FieldType Is Nothing Then
                Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_UnsupportedFieldType2, field_info.Name, "Empty")), vbErrors.IllegalFuncCall)
            End If
            ...
            Else
                Select Case Type.GetTypeCode(FieldType)
                    ...
                    Case TypeCode.DBNull
                        Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_UnsupportedFieldType2, field_info.Name, "DBNull")), vbErrors.IllegalFuncCall)
                    Case Else 'Case TypeCode.Object
                        ...
                        ElseIf FieldType Is GetType(System.Exception) Then
                            Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_UnsupportedFieldType2, field_info.Name, "Exception")), vbErrors.IllegalFuncCall)
                        ElseIf FieldType Is GetType(System.Reflection.Missing) Then
                            Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_UnsupportedFieldType2, field_info.Name, "Missing")), vbErrors.IllegalFuncCall)
                        Else
                            Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_UnsupportedFieldType2, field_info.Name, FieldType.Name)), vbErrors.IllegalFuncCall)
                        End If
                End Select
            End If
                    ...
                    Select Case Type.GetTypeCode(typ)
                        ...
                        Case Else
                            ...
                            ElseIf typ Is GetType(System.Reflection.Missing) Then
                                s = "Error 448"
                            Else
                                Throw New ArgumentException(SRExt.Format(SR.Argument_UnsupportedIOType1, VBFriendlyName(typ)))
                            End If
                    End Select
                End If
