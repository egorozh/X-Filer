        ...
        Friend Shared Function ReportPropertyMismatch(ByVal targetProcedure As Method, ByVal flags As BindingFlags) As Exception
            ...
            If HasFlag(flags, BindingFlagsSetProperty) Then
                ...
                Return New MissingMemberException(
                    SRExt.Format(SR.NoSetProperty1, targetProcedure.AsProperty.Name))
            Else
                Debug.Assert(targetProcedure.AsProperty.GetGetMethod Is Nothing, "expected error condition")
                Return New MissingMemberException(
                    SRExt.Format(SR.NoGetProperty1, targetProcedure.AsProperty.Name))
            End If
        End Function
               ...
               members(0).MemberType <> MemberTypes.Property Then
                ...
                If reportErrors Then
                    ...
                    Throw New ArgumentException(
                        SRExt.Format(SR.ExpressionNotProcedure, methodName, baseReference.VBFriendlyName))
                End If
                Return Nothing
            End If
                ...
                If arguments.Length = 0 Then
                    ...
                    If reportErrors Then
                        Throw New InvalidCastException(
                            SRExt.Format(SR.PropertySetMissingArgument1, methodName))
                    End If
            ...
            If Not resolutionResult.ArgumentsValidated Then
                ...
                If Not CanMatchArguments(resolutionResult, arguments, argumentNames, typeArguments, False, Nothing) Then
                    ...
                    If reportErrors Then
                        ...
                        errorMessage = SRExt.Format(SR.MatchArgumentFailure2, resolutionResult.ToString, errorMessage)
            ...
            Else
                ...
                If HasFlag(lookupFlags, BindingFlagsSetProperty) Then
                    ...
                    If reportErrors Then
                        ...
                        Throw New MissingMemberException(
                            SRExt.Format(SR.MethodAssignment1, resolutionResult.AsMethod.Name))
                    End If
                    Return Nothing
                End If
            End If
