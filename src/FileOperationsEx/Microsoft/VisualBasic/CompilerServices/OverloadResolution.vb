...
#End If
        ...
        Private Shared Function ReportOverloadResolutionFailure(
            ...
            Dim message As String = SRExt.Format(errorID, overloadedProcedureName, errorMessage.ToString)
...
#End If
            ...
            If candidates.Count = 0 Then
                ...
                If reportErrors Then
                    ...
                    End If
                    Throw New MissingMemberException(SRExt.Format(errorID, methodName))
                End If
                Return Nothing
            End If
