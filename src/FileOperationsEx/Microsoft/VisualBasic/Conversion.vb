    ...
    Public Module Conversion
        ...
        Public Function Fix(ByVal Number As Object) As Object
            If Number Is Nothing Then
                Throw New ArgumentNullException(SRExt.Format(SR.Argument_InvalidNullValue1, "Number"))
            End If
            ...
            Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_NotNumericType2, NameOf(Number), Number.GetType().FullName)), vbErrors.TypeMismatch)
        End Function
        ...
        Public Function Int(ByVal Number As Object) As Object
            If Number Is Nothing Then
                Throw New ArgumentNullException(SRExt.Format(SR.Argument_InvalidNullValue1, NameOf(Number)))
            End If
...
RangeCheck:
            ...
            Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValueType2, NameOf(Number), VBFriendlyName(Number)))
        End Function
...
RangeCheck:
        ...
        Public Function Str(ByVal Number As Object) As String
            ...
            If ValueInterface Is Nothing Then
                Throw New InvalidCastException(SRExt.Format(SR.ArgumentNotNumeric1, NameOf(Number)))
            End If
        ...
        Public Function Val(ByVal Expression As Object) As Double
            ...
            Else
                ...
                Catch ex As OutOfMemoryException
                    Throw ex
                Catch
                    Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_InvalidValueType2, NameOf(Expression), VBFriendlyName(Expression))), vbErrors.OLENoPropOrMethod)
                End Try
