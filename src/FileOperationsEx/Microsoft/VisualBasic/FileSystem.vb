    ...
    Public Module FileSystem
        ...
        Public Sub ChDir(ByVal Path As String)
            ...
            Catch ex As System.IO.FileNotFoundException
                Throw VbMakeException(New FileNotFoundException(SRExt.Format(SR.FileSystem_PathNotFound1, Path)), vbErrors.PathNotFound)
            End Try
        ...
        Public Sub ChDrive(ByVal Drive As Char)
            ...
            If (Drive < chLetterA) OrElse (Drive > chLetterZ) Then
                Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "Drive"))
            End If

            If Not UnsafeValidDrive(Drive) Then
                Throw VbMakeException(New IOException(SRExt.Format(SR.FileSystem_DriveNotFound1, CStr(Drive))), vbErrors.DevUnavailable)
            End If
        ...
        Public Function CurDir(ByVal Drive As Char) As String
            ...
            Drive = System.Char.ToUpperInvariant(Drive)
            If (Drive < chLetterA OrElse Drive > chLetterZ) Then
                Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "Drive")), vbErrors.DevUnavailable)
            End If
...
#End If
        ...
        Public Sub FileCopy(ByVal Source As String, ByVal Destination As String)
            If (Source Is Nothing) OrElse (Source.Length = 0) Then
                Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_PathNullOrEmpty1, "Source")), vbErrors.BadFileNameOrNumber)
            End If

            If (Destination Is Nothing) OrElse (Destination.Length = 0) Then
                Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_PathNullOrEmpty1, "Destination")), vbErrors.BadFileNameOrNumber)
            End If

            '  Error if wildcard characters in name
            If PathContainsWildcards(Source) Then
                Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "Source")), vbErrors.BadFileNameOrNumber)
            End If

            If PathContainsWildcards(Destination) Then
                Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "Destination")), vbErrors.BadFileNameOrNumber)
            End If
            ...
            If CheckFileOpen(oAssemblyData, Destination, OpenModeTypes.Output) Then
                Throw VbMakeException(New IOException(SRExt.Format(SR.FileSystem_FileAlreadyOpen1, Destination)), vbErrors.FileAlreadyOpen)
            End If

            If CheckFileOpen(oAssemblyData, Source, OpenModeTypes.Input) Then
                Throw VbMakeException(New IOException(SRExt.Format(SR.FileSystem_FileAlreadyOpen1, Source)), vbErrors.FileAlreadyOpen)
            End If
        ...
        Public Function FileDateTime(ByVal PathName As String) As DateTime
            ...
            If PathContainsWildcards(PathName) Then
                Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "PathName")), vbErrors.BadFileNameOrNumber)
            End If
            ...
            Throw New FileNotFoundException(SRExt.Format(SR.FileSystem_FileNotFound1, PathName))
        End Function
        ...
        Public Sub Kill(ByVal PathName As String)
                ...
                For i = 0 To files.GetUpperBound(0)
                    ...
                    If (file.Attributes And (FileAttribute.Hidden Or FileAttribute.System)) = 0 Then
                        ...
                        If CheckFileOpen(oAssemblyData, FileName, OpenModeTypes.Any) Then
                            Throw VbMakeException(New IOException(SRExt.Format(SR.FileSystem_FileAlreadyOpen1, FileName)), vbErrors.FileAlreadyOpen)
                        End If
            ...
            If DeleteCount = 0 Then
                Throw New IO.FileNotFoundException(SRExt.Format(SR.KILL_NoFilesFound1, PathName))
            End If
        End Sub
        ...
        Public Sub SetAttr(ByVal PathName As String, ByVal Attributes As FileAttribute)
            ...
            If ((Attributes Or &H27S) <> &H27S) Then
                Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "Attributes"))
            End If
...
#End If
        ...
        Private Sub ValidateAccess(ByVal Access As OpenAccess)
            If Access <> OpenAccess.Default AndAlso
                ...
                Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "Access"))
            End If
        End Sub
        ...
        Private Sub ValidateShare(ByVal Share As OpenShare)
            If Share <> OpenShare.Default AndAlso
                ...
                Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "Share"))
            End If
        End Sub
        ...
        Private Sub ValidateMode(ByVal Mode As OpenMode)
            If Mode <> OpenMode.Input AndAlso
                ...
                Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "Mode"))
            End If
        End Sub
        ...
        Private Sub ValidateGetPutRecordNumber(ByVal RecordNumber As Long)
            If RecordNumber < 1 AndAlso RecordNumber <> -1 Then
                Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "RecordNumber")), vbErrors.BadRecordNum)
            End If
        End Sub
        ...
        Public Function InputString(ByVal FileNumber As Integer, ByVal CharCount As Integer) As String
            Try
                ...
                If (CharCount < 0 OrElse CharCount > (&H7FFFFFFFI / 2)) Then
                    Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "CharCount"))
                End If
...
#End If
        ...
        Friend Function VB6CheckPathname(ByVal oAssemblyData As AssemblyData, ByVal sPath As String, ByVal mode As OpenMode) As String
            ...
            If (sPath.IndexOf("?"c) <> -1 OrElse sPath.IndexOf("*"c) <> -1) Then
                Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidPathChars1, sPath))
            End If
