...
#Enable Warning CA1819 ' Properties should not return arrays
        ...
        Private Function ValidatePath(ByVal path As String) As String
            ...
            Dim fullPath As String = FileSystemEx.NormalizeFilePath(path, "path")

            ' Make sure the file exists
            If Not File.Exists(fullPath) Then
                Throw New IO.FileNotFoundException(SRExt.Format(SR.IO_FileNotFound_Path, fullPath))
            End If
            ...
            While Index <= LineEndIndex
                ...
                If QuoteDelimited Then
                    ...
                    If EndHelper.MalformedLine Then
                        ...
                        Throw New MalformedLineException(SRExt.Format(SR.TextFieldParser_MalFormedDelimitedLine, CurrentLineNumber.ToString(CultureInfo.InvariantCulture)), CurrentLineNumber)
                    End If
                    ...
                    Else
                        ...
                        Do
                            ...
                            If Line.Length + NewLine.Length > m_MaxLineSize Then
                                m_ErrorLine = Line.TrimEnd(Chr(13), Chr(10))
                                m_ErrorLineNumber = CurrentLineNumber
                                Throw New MalformedLineException(SRExt.Format(SR.TextFieldParser_MaxLineSizeExceeded, CurrentLineNumber.ToString(CultureInfo.InvariantCulture)), CurrentLineNumber)
                            End If
        ...
        Private Sub ValidateFixedWidthLine(ByVal Line As StringInfo, ByVal LineNumber As Long)
            ...
            If Line.LengthInTextElements < m_LineLength Then
                ...
                Throw New MalformedLineException(SRExt.Format(SR.TextFieldParser_MalFormedFixedWidthLine, LineNumber.ToString(CultureInfo.InvariantCulture)), LineNumber)
            End If
