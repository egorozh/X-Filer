        ...
        Public Property TimeString() As String
            ...
            Set(ByVal Value As String)
                ...
                Catch ex As OutOfMemoryException
                    Throw ex
                Catch
                    Throw VbMakeException(New InvalidCastException(SRExt.Format(SR.InvalidCast_FromStringTo, Left(Value, 32), "Date")), vbErrors.IllegalFuncCall)
                End Try
...
#End If
        ...
        Public Function DateAdd(ByVal Interval As DateInterval,
            ...
            Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "Interval"))
        End Function
        ...
        Public Function DateAdd(ByVal Interval As String,
            ...
            Catch ex As OutOfMemoryException
                Throw ex
            Catch
                Throw New InvalidCastException(SRExt.Format(SR.Argument_InvalidDateValue1, "DateValue"))
            End Try
        ...
        Public Function DateDiff(ByVal Interval As String,
            ...
            Catch ex As OutOfMemoryException
                Throw ex
            Catch
                Throw New InvalidCastException(SRExt.Format(SR.Argument_InvalidDateValue1, "Date1"))
            End Try
            Try
                dt2 = CDate(Date2)
            Catch ex As StackOverflowException
            ...
            Catch ex As OutOfMemoryException
                Throw ex
            Catch
                Throw New InvalidCastException(SRExt.Format(SR.Argument_InvalidDateValue1, "Date2"))
            End Try
        ...
        Public Function DateSerial(ByVal [Year] As Integer, ByVal [Month] As Integer, ByVal [Day] As Integer) As DateTime
            ...
            Catch ex As OutOfMemoryException
                Throw ex
            Catch
                Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "Year")), vbErrors.IllegalFuncCall)
            End Try
            ...
            Catch ex As OutOfMemoryException
                Throw ex
            Catch
                Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "Month")), vbErrors.IllegalFuncCall)
            End Try
            ...
            Catch ex As OutOfMemoryException
                Throw ex
            Catch
                Throw VbMakeException(New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "Day")), vbErrors.IllegalFuncCall)
            End Try
        ...
        Public Function Weekday(ByVal DateValue As DateTime, Optional ByVal DayOfWeek As FirstDayOfWeek = FirstDayOfWeek.Sunday) As Integer
            ...
            ElseIf (DayOfWeek < FirstDayOfWeek.Sunday) OrElse (DayOfWeek > FirstDayOfWeek.Saturday) Then
                Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "DayOfWeek"))
            End If
        ...
        Public Function MonthName(ByVal Month As Integer, Optional ByVal Abbreviate As Boolean = False) As String
            ...
            If Month < 1 OrElse Month > 13 Then
                Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "Month"))
            End If
        ...
        Public Function WeekdayName(ByVal Weekday As Integer, Optional ByVal Abbreviate As Boolean = False, Optional ByVal FirstDayOfWeekValue As FirstDayOfWeek = FirstDayOfWeek.System) As String
            ...
            If (Weekday < 1) OrElse (Weekday > 7) Then
                Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "Weekday"))
            End If

            If (FirstDayOfWeekValue < 0) OrElse (FirstDayOfWeekValue > 7) Then
                Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "FirstDayOfWeekValue"))
            End If
