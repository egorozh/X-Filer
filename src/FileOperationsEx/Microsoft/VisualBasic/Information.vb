    ...
    Public Module Information
        ...
        Public Function LBound(ByVal Array As System.Array, Optional ByVal Rank As Integer = 1) As Integer
            ...
            ElseIf (Rank < 1) OrElse (Rank > Array.Rank) Then
                Throw New RankException(SRExt.Format(SR.Argument_InvalidRank1, NameOf(Rank)))
...
#End If
        ...
        Public Function QBColor(ByVal Color As Integer) As Integer
            If (Color And &HFFF0I) <> 0 Then
                Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, NameOf(Color)), NameOf(Color))
            End If
        ...
        Public Function RGB(ByVal Red As Integer, ByVal Green As Integer, ByVal Blue As Integer) As Integer
            If (Red And &H80000000I) <> 0 Then
                Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, NameOf(Red)), NameOf(Red))
            ElseIf (Green And &H80000000I) <> 0 Then
                Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, NameOf(Green)), NameOf(Green))
            ElseIf (Blue And &H80000000I) <> 0 Then
                Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, NameOf(Blue)), NameOf(Blue))
            End If
