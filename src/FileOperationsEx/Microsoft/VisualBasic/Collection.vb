    ...
    Public NotInheritable Class Collection : Implements ICollection, IList
                ...
                ElseIf Before IsNot Nothing Then
                    ...
                    If beforeString IsNot Nothing Then
                        ...
                        If Not m_KeyedNodesHash.TryGetValue(beforeString, BeforeNode) Then
                            Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, NameOf(Before)), NameOf(Before))
                        End If
                ...
                Else
                    ...
                    If afterString IsNot Nothing Then
                        ...
                        If Not m_KeyedNodesHash.TryGetValue(afterString, AfterNode) Then
                            Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, NameOf(After)), NameOf(After))
                        End If
        ...
        Public Function Contains(ByVal Key As String) As Boolean
            If Key Is Nothing Then
                Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, NameOf(Key)), NameOf(Key))
            End If
        ...
        Default Public Overloads ReadOnly Property Item(ByVal Key As String) As Object
            Get
                ...
                If Not m_KeyedNodesHash.TryGetValue(Key, node) Then
                    Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, "Index"), NameOf(Key))
                End If
                Debug.Assert(node IsNot Nothing)
            ...
            Get
                ...
                Else
                    ...
                    Catch ex As OutOfMemoryException
                        Throw ex
                    Catch
                        Throw New ArgumentException(SRExt.Format(SR.Argument_InvalidValue1, NameOf(Index)), NameOf(Index))
                    End Try
...
#Region "Interface Implementation"
        ...
        Private Sub ICollectionCopyTo(ByVal [array] As System.Array, ByVal index As Integer) Implements ICollection.CopyTo
            If [array] Is Nothing Then
                Throw New ArgumentNullException(NameOf(array), SRExt.Format(SR.Argument_InvalidNullValue1, NameOf(array)))
            End If

            If [array].Rank <> 1 Then
                Throw New ArgumentException(SRExt.Format(SR.Argument_RankEQOne1, NameOf(array)), NameOf(array))
            End If
